      ...
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row -mt-16 md:-mt-24 relative z-20 border border-gray-100">
        ...
        <div className="md:w-2/3 p-8 md:p-12 lg:p-16">
          <p className="text-gray-600 mb-6 leading-relaxed">
            Olá, sou a <span className="font-bold">Fernanda Abreu Mangia</span>, psicóloga clínica com mestrado em Saúde Coletiva pela UFF, <span className="font-bold">especialista em Psicologia Clínica e Psicologia da Saúde.</span>
          </p>

          <p className="text-gray-600 mb-6 leading-relaxed">
            Trabalho com <span className="text-[#4A5D4A] font-semibold">Terapia Cognitivo-Comportamental (TCC)</span> e <span className="text-[#4A5D4A] font-semibold">Terapia do Esquema</span>, oferecendo uma escuta acolhedora e uma abordagem personalizada para cada fase da vida — respeitando a história e o ritmo único de cada pessoa.
          </p>

          <p className="text-gray-600 mb-8 leading-relaxed italic">
            Atendo crianças, adolescentes, adultos e idosos. Também realizo Avaliação Psicológica, Avaliação Neuropsicológica e Orientação Vocacional e Profissional.
          </p>

          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-3 text-gray-700">
              <CheckCircle2 className="text-[#B4C2B4]" size={20} />
              <span>Atendimentos online e presenciais em Niterói (Icaraí) e Nova Friburgo.</span>
            </div>
            <div className="flex items-center gap-3 text-gray-700">
              <CheckCircle2 className="text-[#B4C2B4]" size={20} />
              <span>Agenda de segunda a sexta; sábados a combinar.</span>
            </div>
          </div>

          <p className="text-[#4A5D4A] font-serif italic text-xl">
            "Dar o primeiro passo é o mais importante. Estou aqui para caminhar com você."
          </p>
        </div>
      </div>
    </div>
