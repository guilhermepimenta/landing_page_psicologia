          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex flex-col gap-3 w-full md:w-auto md:min-w-[200px]">
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#0a4620] hover:bg-[#0d6a34] text-white font-bold px-7 py-3.5 rounded-2xl transition-all shadow-md hover:shadow-lg active:scale-95 text-sm"
              >
